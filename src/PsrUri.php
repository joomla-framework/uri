 ...
 * PsrUri Class
 *
 * This is an implementation of the PSR-7 UriInterface
 *
 * @since  __DEPLOY_VERSION__
 */
class PsrUri extends AbstractUri implements PsrInterface
{
	/**
	...
	{
		// If the port is not null perform sanity checks
		if ($port !== null)
		{
			if (!is_numeric($port))
			{
	 ...
	 * @todo   Deal with paths not beginning with a slash ("/")
	 */
